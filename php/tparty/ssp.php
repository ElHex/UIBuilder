    ...
    static function simple ( $request, $sql_details, $table, $primaryKey, $columns, $joinQuery = NULL, $extraWhere = '', $groupBy = '', $having = '')
    {
      ...
      // echo $query;
        ...
        //get primary key
         ...
         $primaryKObj = SSP::sql_exec( $db,$bindings,"SELECT COLUMN_NAME FROM information_schema.KEY_COLUMN_USAGE WHERE TABLE_NAME = '$table' AND CONSTRAINT_NAME = 'PRIMARY'");

       //  echo "Primaryk   ".$primaryKObj[0]["COLUMN_NAME"];

         if($primaryKey==""){
            $primaryKey = $primaryKObj[0]["COLUMN_NAME"];
